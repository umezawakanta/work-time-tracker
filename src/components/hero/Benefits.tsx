...
const iconMap: Record<string, React.ReactNode> = {
  priorityTask: <Lightbulb className="h-6 w-6 text-blue-600" aria-hidden />,
  focusTimer: <Timer className="h-6 w-6 text-emerald-600" aria-hidden />,
  weeklyReport: <BarChart3 className="h-6 w-6 text-purple-600" aria-hidden />,
};
