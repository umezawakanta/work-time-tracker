...
export function GoalForm({ goal, onSave, onCancel }) {
  ...
  const handleInputChange = (e) => {
    ...
    setFormData({
      ...formData,
      [name]:
        name === 'startValue' || name === 'currentValue' || name === 'targetValue'
          ? parseFloat(value) || 0
          : value,
    });
  };
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="mt-2">
            ...
            <p className="text-right text-xs text-gray-500 mt-1">{Math.round(progress)}% 達成</p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <Label htmlFor="targetValue">
            目標値 (円) <span className="text-red-500">*</span>
          </Label>
          <Input
            id="targetValue"
            name="targetValue"
