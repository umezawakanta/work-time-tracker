  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="py-4">
          <div className="mb-4">
            <label htmlFor="referral-code" className="text-sm font-medium mb-2 block">あなたの紹介コード</label>
            <div className="flex">
              <input
                id="referral-code"
                type="text"
          ...
          <div className="mb-4">
            <label htmlFor="share-link" className="text-sm font-medium mb-2 block">共有リンク</label>
            <div className="flex">
              <input
                id="share-link"
                type="text"
          ...
          <div className="mt-6 bg-amber-50 p-3 rounded-md">
            ...
            <ul className="mt-2 space-y-1">
              <li className="text-xs text-amber-700 flex items-start">
                <div className="text-amber-600 mr-2" aria-hidden="true">•</div>
          ...
          <div className="mt-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={() => {
                  const text = encodeURIComponent(`タスク管理アプリで生産性向上！あなたとわたしにプレミアム特典付き ${shareLink}`);
