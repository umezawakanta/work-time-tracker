...
const AdvancedOptions: React.FC<AdvancedOptionsProps> = ({
  ...
  // アクションのフィルタリングと表示
  const filteredActions = showAllActivities 
    ? recentActions 
                ...
                <div className="flex-1">
                  ...
                  {isImporting && (
                    <div className="mt-2">
                      ...
                      <p className="text-xs text-gray-500 mt-1">インポート中... {importProgress}%</p>
                    </div>
                  )}
                  ...
                  {importFile && !isImporting && (
                    <div className="mt-2">
                      ...
                      <span className="text-xs ml-2">
                        形式: {importFormat === 'auto' ? detectFileFormat(importFile) : importFormat}
                      </span>
                    </div>
                  )}
              ...
              {filteredActions.length > 0 ? (
                <ul className="space-y-1 py-2">
                  {filteredActions.map((action, index) => (
                    <li key={index} className="text-xs flex justify-between items-center py-1 border-b border-gray-100 last:border-0">
              ...
              <div className="py-2">
                <Badge
                  ...
                  className={`cursor-pointer transition-colors ${
                    ...
                    autoAdjustEnabled ? 'bg-green-50 hover:bg-green-100' : 'bg-gray-50 hover:bg-gray-100'
                  }`}
