...
import { Calendar, CheckCircle, Circle, ArrowUpDown, Target, Clock, X } from 'lucide-react';
                ...
                {statusOptions.map((option) => (
                  <Button
                    ...
                    className={cn(
                      ...
                      filterStatus === option.value ? 'shadow-sm' : 'hover:shadow-sm'
                    )}
                  >
                ...
                {categoryOptions.map((option) => (
                  <Button
                    ...
                    className={cn(
                      ...
                      categoryFilter === option.value ? 'shadow-sm' : 'hover:shadow-sm'
                    )}
            ...
            <>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground">適用中のフィルター:</span>
