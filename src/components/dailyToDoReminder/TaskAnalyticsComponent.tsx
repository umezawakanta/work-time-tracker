    ...
    if (activeTab === 'insights' && isPremium) {
      ...
      setTimeout(() => {
        const tips = [
          ...
          `平均タスク完了時間は${stats.averageCompletionTime < 60 ? `${stats.averageCompletionTime}分` : `${(stats.averageCompletionTime / 60).toFixed(1)}時間`}です。時間見積もりを改善しましょう。`,
      ...
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as AnalyticsTab)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card>
              ...
              <CardContent className="py-2">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  期限内: {stats.tasksCompletedBeforeDeadline}タスク / 期限超過: {stats.tasksCompletedAfterDeadline}タスク
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="py-2">
                ...
                <Progress 
                  ...
                  className="h-2 mt-2" 
                  indicatorClassName={
                    productivityScore >= 80 ? "bg-green-600" :
                    productivityScore >= 60 ? "bg-blue-600" :
                    productivityScore >= 40 ? "bg-amber-600" : "bg-gray-600"
                  }
                />
                <p className="text-xs text-muted-foreground mt-2">
        ...
        <TabsContent value="productivity">
          <Card>
            ...
            <CardContent>
              <p className="text-sm">このセクションでは、あなたのタスク完了パターンと効率性を分析します。</p>
        ...
        <TabsContent value="trends">
          <Card>
            ...
            <CardContent>
              <p className="text-sm">このセクションでは、時間経過に伴うタスク完了の傾向を表示します。</p>
              <p className="text-sm mt-2">実装中の機能です。今後のアップデートをお待ちください。</p>
            </CardContent>
          </Card>
        </TabsContent>
