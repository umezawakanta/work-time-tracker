 ...
 */
export const BadgeCompletionPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>バッジ完了予測 | Work Time Tracker</title>
        <meta
          name="description"
          content="全バッジ獲得までの作業時間・達成予定日・マイルストーンを分析し、最適な学習計画を提案します。AI駆動の進捗予測で効率的なスキルアップを実現。"
        />
        <meta
          name="keywords"
          content="バッジ,完了予測,作業時間,達成予定日,マイルストーン,学習計画,スキルアップ,AI予測"
        />
        <meta property="og:title" content="🎯 バッジ完了予測 - Work Time Tracker" />
        <meta
          property="og:description"
          content="AI駆動の進捗予測システムで全バッジ獲得までの最適なロードマップを表示"
        />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="/badge-completion" />
      </Helmet>
