...
export class AIModelRegistry {
    ...
    public initialize(): void {
        ...
        this.logger.info(`モデルレジストリを初期化しました: ${this.models.size}モデルが登録されています`);
    }
    ...
    private registerDefaultModels(): void {
        ...
        this.registerModel({
            ...
            provider: 'openai',
            capabilities: [
                'chat-completion', 'query-optimization', 'content-generation',
                'text-summarization', 'sentiment-analysis', 'entity-extraction',
                'translation', 'text-classification', 'code-generation',
                'code-explanation', 'data-analysis', 'question-answering'
            ],
            maxTokens: 4096,
        ...
        this.registerModel({
            ...
            capabilities: [
                ...
                'text-summarization', 'sentiment-analysis', 'entity-extraction',
                'translation', 'text-classification', 'code-generation',
                'code-explanation', 'question-answering'
            ],
            maxTokens: 4096,
            contextWindow: 16385,
        ...
        this.registerModel({
            ...
            capabilities: [
                'chat-completion', 'query-optimization', 'content-generation',
                'text-summarization', 'sentiment-analysis', 'entity-extraction',
                'translation', 'text-classification', 'question-answering'
            ],
            maxTokens: 4096,
            contextWindow: 200000,
    ...
    private saveCustomModels(): void {
        try {
            if (typeof localStorage !== 'undefined') {
                const customModels = Array.from(this.models.values())
                    .filter(model => model.metadata.custom === true);
