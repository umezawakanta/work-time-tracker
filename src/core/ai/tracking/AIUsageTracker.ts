...
export class AIUsageTracker {
    ...
    private persistData(): void {
        try {
            ...
            if (typeof localStorage !== 'undefined') {
                localStorage.setItem('ai-usage-data', JSON.stringify({
    ...
    public trackUsage(
        ...
        this.logger.debug(`使用状況を記録しました: ${model.id}, ${totalTokens}トークン, $${estimatedCost.toFixed(6)}`);
    }
