...
export class AICacheManager {
   ...
   * タイプ別統計を更新
   */
  private incrementTypeStat(type: AIEnhancementType, stat: 'hits' | 'misses'): void {
   ...
   * エントリの優先度を計算
   */
  private calculatePriority(type: AIEnhancementType, options: AIFeatureOptions): number {
    // デフォルトはノーマル優先度
