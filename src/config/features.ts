...
export const featuresRegistry: Feature[] = [
  ...
  {
    id: 'daily-10-tasks-instructions',
    name: '📋 毎日20のこと詳細手順説明',
    path: '/daily-10-tasks',
    category: '生産性',
    description: '各タスクの詳細な手順説明とクイックスタートガイド',
    status: 'complete',
    requiresRealAPI: false,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'daily-10-tasks-subtasks',
    name: '🔧 毎日20のことサブタスク機能',
    path: '/daily-10-tasks',
    category: '生産性',
    description: '5分以内で完了できるサブタスクの分割と管理',
    status: 'complete',
    requiresRealAPI: true,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'daily-10-tasks-auto-complete',
    name: '⚡ 毎日20のこと自動完了機能',
    path: '/daily-10-tasks',
    category: '生産性',
    description: '資産管理ページでの入力に基づく自動タスク完了',
    status: 'complete',
    requiresRealAPI: true,
    priority: 'P1',
    targetRelease: '2025-01-25',
  },
  {
    ...
    category: '生産性',
    description:
      '複数銀行口座の登録・管理・設定・CSVインポート機能・取引明細一覧・収支分析・操作手順ガイド完備・データ永続化対応・メイン口座以外も登録可能・三井住友銀行・横浜銀行・じぶん銀行対応',
    status: 'complete',
    requiresRealAPI: true,
    priority: 'P0',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'bank-account-auth-fix',
    name: '🔐 銀行口座管理認証修正',
    path: '/bank-accounts',
    category: '品質',
    description: '開発環境での認証問題修正とデバッグ情報追加',
    status: 'complete',
    requiresRealAPI: false,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'yokohama-bank-support',
    name: '🏦 横浜銀行対応',
    path: '/bank-accounts',
    category: '生産性',
    description: '横浜銀行の取引明細CSV形式への対応・自動解析・カテゴリ分類',
    status: 'complete',
    requiresRealAPI: true,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'jibun-bank-support',
    name: '🏦 じぶん銀行対応',
    path: '/bank-accounts',
    category: '生産性',
    description: 'じぶん銀行の取引明細CSV形式への対応・自動解析・カテゴリ分類',
    status: 'complete',
    requiresRealAPI: true,
    priority: 'P1',
    targetRelease: '2025-01-25',
  },
  {
    ...
    path: '/bank-import',
    category: '生産性',
    description: 'CSVファイルによる銀行取引履歴の取り込み',
    status: 'complete',
    requiresRealAPI: true,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'api-404-fix',
    name: '🔧 本番環境API 404エラー修正',
    path: '/api',
    category: '品質',
    description: 'Vercel本番環境でのAPI 404エラーの修正',
    status: 'complete',
    requiresRealAPI: false,
    priority: 'P0',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'api-cors-standardization',
    name: '🌐 API CORS設定統一',
    path: '/api',
    category: '品質',
    description: '全APIエンドポイントのCORS設定統一',
    status: 'complete',
    requiresRealAPI: false,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'api-user-id-fallback',
    name: '👤 API デフォルトユーザーID対応',
    path: '/api',
    category: '品質',
    description: '認証なしでも動作するデフォルトユーザーID機能',
    status: 'complete',
    requiresRealAPI: false,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'bank-accounts-dev-api',
    name: '🏦 銀行口座管理開発API',
    path: '/api/bank-accounts',
    category: '品質',
    description: '開発環境での銀行口座管理API実装',
    status: 'complete',
    requiresRealAPI: false,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'bank-accounts-crud',
    name: '🔧 銀行口座CRUD操作',
    path: '/api/bank-accounts',
    category: '生産性',
    description: '銀行口座の作成・読み取り・更新・削除機能',
    status: 'complete',
    requiresRealAPI: true,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  {
    id: 'bank-accounts-main-validation',
    name: '✅ メイン口座重複チェック',
    path: '/api/bank-accounts',
    category: '品質',
    description: 'メイン口座の重複登録を防ぐバリデーション機能',
    status: 'complete',
    requiresRealAPI: false,
    priority: 'P1',
    targetRelease: '2025-01-25',
  ...
  // Impulse Control - ドーパミン不全による衝動行動抑制
  {
    id: 'dopamine-guard',
    name: '🛡️ ドーパミンガード',
    path: '/guard',
    category: 'Impulse Control',
    description: '衝動行動の先回り遮断と環境設計',
    status: 'planning',
    requiresRealAPI: false,
    priority: 'P0',
  ...
  {
    id: 'daily-review-enhanced',
    name: '📝 デイリーレビュー（拡張）',
    path: '/daily-review',
    category: 'Impulse Control',
    description: 'スリップの前兆と修復策を含む日次振り返り',
    status: 'planning',
    requiresRealAPI: false,
    priority: 'P1',
    targetRelease: '2025-01-20',
  ...
  },
  {
    ...
    path: '/education',
    category: 'Impulse Control',
    description: '認知再評価と行動活性化の短文化コンテンツ',
    status: 'planning',
    requiresRealAPI: false,
    priority: 'P2',
    targetRelease: '2025-01-25',
