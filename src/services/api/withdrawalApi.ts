...
export const withdrawalApi = {
  getAll: (): Promise<AxiosResponse<WithdrawalEntry[]>> => {
    ...
    return USE_MOCK_DATA
      ? Promise.resolve({ data: mockWithdrawalData } as AxiosResponse<
          WithdrawalEntry[]
        >)
  ...
  create: (
    entry: Omit<WithdrawalEntry, "_id">
    ...
    return USE_MOCK_DATA
      ...
      : api
          .post<WithdrawalApiResponse>("/withdrawal", entry)
          .then((response) => {
  ...
  update: (
    ...
    return USE_MOCK_DATA
      ...
      : api
          .put<WithdrawalApiResponse>(`/withdrawal/${_id}`, entry)
          .then((response) => {
