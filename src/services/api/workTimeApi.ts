...
export const workTimeApi = {
  getAll: (): Promise<AxiosResponse<WorkTimeEntry[]>> => {
    ...
    return USE_MOCK_DATA
      ? Promise.resolve({ data: mockWorkTimeData } as AxiosResponse<WorkTimeEntry[]>)
  ...
  update: (
    ...
    return USE_MOCK_DATA
      ...
      : api.put<WorkTimeApiResponse>(`/worktime/${_id}`, entry).then((response) => {
