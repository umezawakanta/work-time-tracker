...
| 機能           | Gemini             | Claude       | GPT-4          |
| -------------- | ------------------ | ------------ | -------------- |
| 無料枠         | あり               | なし         | なし           |
| レスポンス速度 | 高速               | 中速         | 中速           |
| 分析精度       | 高                 | 非常に高     | 最高           |
| 日本語対応     | 優秀               | 優秀         | 優秀           |
| レート制限     | 60/分              | 50/分        | 500/分         |
| コスト         | 無料枠後は従量課金 | 低〜中コスト | 高コスト       |
| 推奨用途       | 開発・日常利用     | バランス重視 | 最高精度要求時 |
...
| 使用量        | Gemini | Claude | GPT-4  |
| ------------- | ------ | ------ | ------ |
| 100タスク/月  | 無料   | $0.02  | $1.50  |
| 500タスク/月  | 無料   | $0.10  | $7.50  |
| 1500タスク/月 | 無料   | $0.30  | $22.50 |
| 5000タスク/月 | $0.50  | $1.00  | $75.00 |
